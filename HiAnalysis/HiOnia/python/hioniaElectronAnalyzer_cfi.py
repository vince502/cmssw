...
hioniaElectrons = cms.EDAnalyzer(
    ...
    useVIDElectronID=cms.bool(False),
    eleVIDVetoIdMap=cms.InputTag(''),
    eleVIDLooseIdMap=cms.InputTag(''),
    eleVIDMediumIdMap=cms.InputTag(''),
    eleVIDTightIdMap=cms.InputTag(''),
    computeHIMVAId=cms.bool(False),
    hiMVAIdModel=cms.FileInPath('HeavyIonsAnalysis/EGMAnalysis/data/Run3_2023_PbPb/eleid_BDT.ubj'),
    hiMVARho=cms.InputTag('fixedGridRhoFastjetAll'),
    hiMVARhoEtaMap=cms.InputTag('hiFJRhoProducer', 'mapEtaEdges'),
    hiMVARhoMap=cms.InputTag('hiFJRhoProducer', 'mapToRho'),
