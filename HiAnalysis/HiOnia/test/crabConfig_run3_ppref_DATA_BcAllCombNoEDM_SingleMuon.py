...
config.General.requestName = 'OniaTree_ppRef2024_DATA_BcAllCombNoEDM_SingleMu3Mu5_05Mar2026_v1'
...
config.JobType.psetName = 'hionia_bcAllCombNoEDM_ppRef2024_DATA_slimmed_singlemu_cfg.py'
config.JobType.maxMemoryMB = 2800
config.JobType.numCores = 1

config.section_('Data')
config.Data.outputPrimaryDataset = 'PPRefSingleMuonAll'
...
config.Data.userInputFiles = open('PRefSglMu.txt').readlines()
