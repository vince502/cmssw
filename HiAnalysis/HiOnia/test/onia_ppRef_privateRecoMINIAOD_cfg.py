...
PDname = 'PhysicsPPRefDoubleMuon0'
...
options.outputFile = f"/eos/cms/store/group/phys_heavyions/dileptons/Data2024/ppRef/FastOniatrees/{outputName}.root"
...
if applyEventSel:
    ...
    process.hltHI.HLTPaths = ["HLT_PPRefL*DoubleMu*","HLT_PPRefL*SingleMu*"]
    process.hltHI.throw = False
    process.hltHI.andOr = True


    # Muon filtering
    SuperLooseMuonCut = "(isTrackerMuon || isGlobalMuon) && pt > .8 && abs(eta) < 2.4"
