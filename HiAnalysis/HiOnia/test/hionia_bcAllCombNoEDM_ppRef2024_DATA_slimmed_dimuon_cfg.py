...
if hasattr(process, "hltHI"):
    ...
    print("[WARN] hltHI not found; DoubleMu trigger override not applied")

print("============================================================")
print("hionia + bcSemiLepAll (NoEDM) wrapper ready")
print("  dataset mode  = DoubleMuon")
print("  HLT filter    = HLT_PPRefL*DoubleMu*_v*")
print("  onia output   =", options.outputFile)
print("  channels      = MuMuMu, MuMuE (EEMu/EEE disabled)")
print("============================================================")
