...
process.bToJpsiHadronsEE = cms.EDProducer("BToJpsiHadronsProducer",
    ...
    kstarMassWindow = cms.double(0.1),
    ...
    minTrackDxySig = cms.double(0.0),
    minTrackDzSig = cms.double(0.0),
    ...
    xMassMax = cms.double(10.0),
    xMassMin = cms.double(3.5),
    xPiPiMassMax = cms.double(1.5)
)


process.bToJpsiHadronsMuMu = cms.EDProducer("BToJpsiHadronsProducer",
    b0MassWindow = cms.double(0.5),
    bPlusMassWindow = cms.double(0.5),
    bcMassWindow = cms.double(0.5),
    beamSpotSrc = cms.InputTag("offlineBeamSpot"),
...
process.chiCandidatesEE = cms.EDProducer("OniaPhotonProducer",
    beamSpotSrc = cms.InputTag("offlineBeamSpot"),
...
process.chiCandidatesMuMu = cms.EDProducer("OniaPhotonProducer",
    beamSpotSrc = cms.InputTag("offlineBeamSpot"),
    constraintMass = cms.double(3.0969),
    conversionSrc = cms.InputTag("oniaPhotonCandidates","conversions"),
    deltaMassRange = cms.vdouble(0.0, 2.0),
...
process.updatedPatJetsTransientCorrectedAK4PFBtag = cms.EDProducer("PATJetUpdater",
    ...
    printWarning = cms.bool(True),
    sort = cms.bool(True),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAK4PFBtag"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAK4PFBtag"), cms.InputTag("pfDeepCSVTagInfosAK4PFBtag"), cms.InputTag("pfDeepFlavourTagInfosAK4PFBtag"), cms.InputTag("pfUnifiedParticleTransformerAK4TagInfosAK4PFBtag")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.HiForestInfo = cms.EDAnalyzer("HiForestInfo",
    ...
    info = cms.vstring('HiForest, miniAOD, 150X, OO 2025 data, UnifiedBMeson')
)
...
process.bTreeEE = cms.EDAnalyzer("BToJpsiHadronsNtuplizer",
...
process.bTreeMuMu = cms.EDAnalyzer("BToJpsiHadronsNtuplizer",
...
process.chiTreeEE = cms.EDAnalyzer("ChiCNtupleProducer",
...
process.chiTreeMuMu = cms.EDAnalyzer("ChiCNtupleProducer",
...
process.patAlgosToolsTask = cms.Task(process.patJetCorrFactorsAK4PFBtag, process.patJetCorrFactorsTransientCorrectedAK4PFBtag, process.pfDeepCSVTagInfosAK4PFBtag, process.pfDeepFlavourTagInfosAK4PFBtag, process.pfImpactParameterTagInfosAK4PFBtag, process.pfInclusiveSecondaryVertexFinderTagInfosAK4PFBtag, process.pfJetProbabilityBJetTagsAK4PFBtag, process.pfUnifiedParticleTransformerAK4JetTagsAK4PFBtag, process.pfUnifiedParticleTransformerAK4TagInfosAK4PFBtag, process.selectedUpdatedPatJetsAK4PFBtag, process.updatedPatJetsAK4PFBtag, process.updatedPatJetsTransientCorrectedAK4PFBtag)
...
process.forest = cms.Path(process.eventFilter+process.HiForestInfo+process.centralityBin+process.hiEvtAnalyzer+process.hltanalysis+process.particleFlowAnalyser+process.unpackedTracksAndVertices+process.unpackedMuons+process.akCs4PFJetAnalyzer+process.akPu4CaloJetAnalyzer, process.patAlgosToolsTask)


process.btagPath = cms.Path(process.eventFilter+process.akCs4PFJetAnalyzer_btag)


process.oniaPath = cms.Path(process.eventFilter+process.oniaTreeAna)


process.bMesonMuMuPath = cms.Path(process.eventFilter+process.bToJpsiHadronsMuMu+process.bTreeMuMu)


process.bMesonEEPath = cms.Path(process.eventFilter+process.bToJpsiHadronsEE+process.bTreeEE)


process.chiCMuMuPath = cms.Path(process.eventFilter+process.chiCandidatesMuMu+process.chiTreeMuMu)


process.chiCEEPath = cms.Path(process.eventFilter+process.chiCandidatesEE+process.chiTreeEE)
...
process.schedule = cms.Schedule(*[ process.forest, process.oniaPath, process.bMesonMuMuPath, process.bMesonEEPath, process.chiCMuMuPath, process.chiCEEPath, process.btagPath, process.pclusterCompatibilityFilter, process.pprimaryVertexFilter, process.pAna ])
