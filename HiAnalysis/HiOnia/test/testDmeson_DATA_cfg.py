...
# Process
#----------------------------------------------------------------------------
process = cms.Process("DmesonDATA", eras.Run3_2025_OXY)

# Command line options
options = VarParsing.VarParsing('analysis')
options.outputFile = "Dmeson_OO_DATA.root"
options.inputFiles = [
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/eos/user/c/cmsdqm/www/CAF/certification/Collisions25OO/Cert_Collisions2025OO_394153_394217_withVdm.json').getVLuminosityBlockRange()
