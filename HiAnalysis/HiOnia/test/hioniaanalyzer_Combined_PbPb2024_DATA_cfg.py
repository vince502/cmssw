...
# Configuration: 2024 PbPb Prompt Reco DATA
#----------------------------------------------------------------------------
...
options.outputFile = 'OniaTree_Combined_PbPb2024_DATA.root'
options.maxEvents = -1
...
globalTag = '141X_dataRun3_Prompt_v4'
...
process.onia2ElectronElectronPatGlbGlb.dielectronSelection = cms.string("mass > 1.5 && charge == 0")
