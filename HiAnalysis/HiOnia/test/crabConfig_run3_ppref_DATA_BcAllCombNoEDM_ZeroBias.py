...
config.General.requestName = 'OniaTree_ppRef2024_DATA_BcAllCombNoEDM_ZeroBias_05Mar2026_v1'
...
config.JobType.psetName = 'hionia_bcAllCombNoEDM_ppRef2024_DATA_slimmed_zerobias_cfg.py'
config.JobType.maxMemoryMB = 5000
config.JobType.numCores = 2

config.section_('Data')
config.Data.outputPrimaryDataset = 'PPRefZeroBiasPlusForwardAll'
...
config.Data.userInputFiles = open('PRefZeroBias.txt').readlines()
