...
# Dataset mode: SingleMuon PD
# - event filter requires SingleMu trigger paths (no electron-trigger requirement)
# - keep ee+mu channel, disable EEE
...
if hasattr(process, "hltHI"):
    ...
    print("[WARN] hltHI not found; SingleMu trigger override not applied")

print("============================================================")
print("hionia + bcSemiLepAll (NoEDM) wrapper ready")
print("  dataset mode  = SingleMuon")
print("  HLT filter    = HLT_PPRefL3SingleMu3_v* OR HLT_PPRefL3SingleMu5_v*")
