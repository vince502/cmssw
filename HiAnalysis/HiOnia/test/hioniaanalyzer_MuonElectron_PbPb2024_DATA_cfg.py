...
#----------------------------------------------------------------------------
# Combined Muon + Electron ONIA TREE: 2024 PbPb Prompt Reco DATA
#----------------------------------------------------------------------------

print("="*80)
print("COMBINED MUON + ELECTRON ONIA TREE ANALYZER")
print("Configuration: 2024 PbPb Prompt Reco DATA")
print("="*80)
...
'file:/eos/cms/store/group/phys_heavyions_ops/soohwan/Run3_2024_ReReco2025/Data/HLTPhysics/ECALDriven/RECO_v1_111.root',
#'file:/eos/cms/store/group/phys_heavyions_ops/soohwan/Run3_2024_ReReco2025/Data/HLTPhysics/ECALDriven/RECO_v1_112.root',
'file:/eos/cms/store/group/phys_heavyions_ops/soohwan/Run3_2024_ReReco2025/Data/HLTPhysics/ECALDriven/RECO_v1_113.root',
]
options.outputFile = 'OniaTree_MuonElectron_PbPb2024_DATA.root'
options.maxEvents = -1
...
globalTag = '141X_dataRun3_Prompt_v4'  # 2024 PbPb Prompt Reco
...
if applyEventSel:
    ...
    process.hltHI.HLTPaths = ["HLT_HIL*SingleMu*_v*", "HLT_HIEle*_v*", "HLT_HIMinimumBiasHF1AND*_v*"]
...
# NOTE: Skipping HI electron ID/ISO (BDT model files not available in this setup)
# Using standard slimmedElectrons
process.onia2ElectronElectronPatGlbGlb.electrons = cms.InputTag('slimmedElectrons')
...
# Update electron analyzer
process.hioniaElectrons.srcElectron = cms.InputTag('slimmedElectrons')

# Add electron analysis to muon path (reuse shared modules)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string(f'file:/eos/home-s/soohwan/Run2025/output/hionia_{sys.argv[2]}.root')
)
