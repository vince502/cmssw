...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        # 'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/step3_mix_PU3.root'
        # 'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/step3_mix.root'
        # 'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/genconfig_py_GEN_SIM.root'
        # 'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/genconfig_py_GEN_SIM_ForEmbedding.root'
        #'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/step2_mix.root'
        'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/OxygenMC/CMSSW_15_0_4/src/FlatPU2/step3_RAW2DIGI_L1Reco_RECO_RECOSIM.root',
    ),
)
...
process.load('HeavyIonsAnalysis.EventAnalysis.quickVtxAna_cfi')
process.load('Validation.RecoVertex.mcverticesanalyzer_cfi')

process.mcverticesanalyzer.pileupSummaryCollection = cms.InputTag("addPileupInfo")
#process.mcverticesanalyzer.pileupSummaryCollection = cms.InputTag("slimmedAddPileupInfo")
process.mcverticesanalyzer.mcTruthCollection = cms.InputTag("generatorSmeared")

process.vtxProp.pileupInfo =  cms.InputTag("addPileupInfo")
#process.vtxProp.pileupInfo =  cms.InputTag("slimmedAddPileupInfo")
process.vtxProp.recoVtxLabel =  cms.untracked.InputTag("offlinePrimaryVertices")
process.vtxProp.hasReco =  cms.untracked.bool(True)
process.vtxProp.useGen =  cms.untracked.bool(True)
