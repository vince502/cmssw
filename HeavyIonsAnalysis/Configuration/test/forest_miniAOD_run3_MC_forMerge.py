...
#        '/store/user/mnguyen//Run3MC/QCD_pThat15_Run3_HydjetEmbedded/QCD_pthat15_Run3_HydjetEmbedded_mAOD_restrictTracking/220714_111445/0000/mAOD_RAW2DIGI_L1Reco_RECO_PAT_99.root'
        'file:/eos/home-s/soohwan/store/HIJPSIEMBMC_Apr2023/RERECO/step3_miniAOD_443.root',
    ),
)
...
oniaTreeAnalyzer(process,
                 ...
                 muonSelection=muonSelection, L1Stage=2, isMC=isMC, pdgID=pdgId, miniAOD=miniAOD, miniAODcuts=miniAOD_muonCuts#, OnlySingleMuons=True
)
if applyCuts:
...
process.oniaTreeAna.replace(process.hionia, process.hiEvtAnalyzer * process.hionia )
