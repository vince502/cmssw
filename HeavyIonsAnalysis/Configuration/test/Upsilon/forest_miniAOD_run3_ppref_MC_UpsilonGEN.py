...
#'/store/mc/RunIIIpp5p36Winter24MiniAOD/Upsilon1SToMuMu_pThat-2_TuneCP5_5p36TeV_pythia8/MINIAODSIM/NoPU_141X_mcRun3_2024_realistic_ppRef5TeV_v7-v1/100000/01f873d1-ed94-4368-8907-6efb5796b2a8.root',
'file:/afs/cern.ch/work/s/soohwan/private/Analysis/MC/ppRef2024/CMSSW_14_1_8/src/HIN-RunIIIpp5p36Winter24GS-00006.root',
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string((f'HiForestMiniAOD_MC_GEN.root')))
...
process.onia2MuMuPatGlbGlb.dimuonSelection       = cms.string("(8 < mass && mass < 14)  && pt > 0")
...
#process.jpsiJetsPath = cms.Path( process.patMuonSequence+process.onia2MuMuPatGlbGlb + process.hionia)
process.jpsiJetsPath = cms.Path(  process.hionia)
