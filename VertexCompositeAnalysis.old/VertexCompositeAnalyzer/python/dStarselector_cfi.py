...
dStarselector = cms.EDProducer('VertexCompositeSelector',
  ...
  GBRForestLabel = cms.string('DStarInPbPb'),
  GBRForestFileName = cms.string('GBRForestfile_BDT_D0InpPb_1_2.root'),
  MVACollection = cms.InputTag("generalDStarCandidatesNew:MVAValues"),
...
dStarselectorMC = cms.EDProducer('VertexCompositeSelector',
  ...
  VertexCollection = cms.untracked.InputTag("offlinePrimaryVertices"),
  TrackCollection = cms.untracked.InputTag("generalTracks"),
  VertexCompositeCollection = cms.untracked.InputTag("generalStarCandidatesNew:DStar"),
  GenParticleCollection = cms.untracked.InputTag("genParticles"),
  MuonCollection = cms.untracked.InputTag("null"),
  doMuon = cms.untracked.bool(False),
  doMuonFull = cms.untracked.bool(False),
