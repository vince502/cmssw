...
DATA_GLOBAL_TAG = "auto:run3_data_HIon"
MC_GLOBAL_TAG = "auto:run3_mc_HIon"

DATA_CENTRALITY_TAG = (
    "CentralityTable_HFtowers200_DataPbPb_offline_v0"
)
MC_CENTRALITY_TAG = (
    "CentralityTable_HFtowers200_HydjetCello_v1401x0_official_MC2024"
)
...
def configureCommon(process, options, isMC):
    ...
    centralityTag = options.centralityTag or (
