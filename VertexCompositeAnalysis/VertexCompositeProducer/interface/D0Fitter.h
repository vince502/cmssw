...
//  auto_ptr<edm::ValueMap<float> > getMVAMap() const;
 ...
 private:
  float evaluateTMVA(float v2dCosPointingAngle,
  ...
  std::string tmvaWeightsFile_;
  std::unique_ptr<TMVA::Reader> tmvaReader_;
...
// When `output_names` is empty, will return all outputs ordered as in `getOutputNames()`.
  ...
  float tmvaV2dCosPointingAngle_ = 0.0f;
  float tmvaV3dCosPointingAngle_ = 0.0f;
  float tmvaV2dDecayLengthSignificance_ = 0.0f;
  float tmvaV3dDecayLengthSignificance_ = 0.0f;
  float tmvaV2dDecayLength_ = 0.0f;
  float tmvaV3dDecayLength_ = 0.0f;
  float tmvaV2dPointingAngle_ = 0.0f;
  float tmvaV3dPointingAngle_ = 0.0f;
  float tmvaPt_ = 0.0f;
  float tmvaEta_ = 0.0f;
  float tmvaNHitD1_ = 0.0f;
  float tmvaNHitD2_ = 0.0f;
  float tmvaPtD1_ = 0.0f;
  float tmvaPtD2_ = 0.0f;
  float tmvaEtaD1_ = 0.0f;
  float tmvaEtaD2_ = 0.0f;
  float tmvaDerivedDauAbsEtaGap_ = 0.0f;
  float tmvaDerivedDauPtImbalance_ = 0.0f;
  float tmvaSpecMass_ = 0.0f;
  float tmvaSpecPt_ = 0.0f;
  float tmvaSpecRapidity_ = 0.0f;
  float tmvaSpecEta_ = 0.0f;
  float tmvaSpecFlavor_ = 0.0f;
  float tmvaSpecMatchGen_ = -999.0f;
  float tmvaSpecIsSwap_ = -999.0f;
  float tmvaSpecAncestorFlavor_ = -999.0f;
  float tmvaSpecIsDataSideband_ = 0.0f;
  float tmvaSpecSourceTree_ = 0.0f;
